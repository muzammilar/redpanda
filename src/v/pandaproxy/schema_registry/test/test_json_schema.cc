    ...
    auto json_schema_def
      = pps::make_json_schema_definition(
          ...
          pps::make_canonical_json_schema(
            f.store(),
            {pps::context_subject::unqualified("test"),
             {fmt::format("{}", fmt::streamed(jsoncons::print(input_schema))),
              pps::schema_type::json}})
            .get())
          .get();
  ...
  "$defs": {
    ...
    BOOST_TEST_CONTEXT(
      fmt::format(
        "input_schema:\n{}\n\nexpected_schema:\n{}\n\nprocessed_schema:\n{}"
        "\n\n",
        fmt::streamed(jsoncons::pretty_print(input_schema)),
        fmt::streamed(jsoncons::pretty_print(expected_schema)),
        fmt::streamed(jsoncons::pretty_print(processed_schema)))) {
        ...
        BOOST_CHECK_MESSAGE(
          ...
          fmt::format(
            ...
            fmt::streamed(jsoncons::pretty_print(jpatch))));
    }
}
